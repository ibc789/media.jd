...
class EdiPoaSendRequest
{
	...
	public function getVendorName(){
	  return $this->vendorName;
                        	                   			...
                        	                   			private $purchaseOrderCode(总目);
    	                        
	public function setPurchaseOrderCode(总目)($purchaseOrderCode(总目)){
		$this->purchaseOrderCode(总目) = $purchaseOrderCode(总目);
         $this->apiParas["purchaseOrderCode(总目)"] = $purchaseOrderCode(总目);
	}

	public function getPurchaseOrderCode(总目)(){
	  return $this->purchaseOrderCode(总目);
	}
